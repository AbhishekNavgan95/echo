...
const CourseUploadTips = () => {
  ...
  return (
    <section className="flex flex-col xl:flex-row gap-5 justify-between items-start bg-richblack-800 border border-richblack-600 px-5 lg:px-10 py-5 lg:py-10 rounded-lg">
