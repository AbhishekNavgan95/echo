    ...
    <div className="flex flex-col w-full px-5 gap-10 justify-center mx-auto py-10 xl:py-20">
      ...
      <div className="flex flex-col text-center md:text-start ">
        ...
        {totalItems > 0 ? (
          ...
          <div className="min-h-[50vh] flex items-center justify-center gap-5 text-center text-2xl text-richblack-300"><span className="text-4xl"><CiSearch /></span> Looks like your Cart is Empty</div>
        )}
      </div>
    </div>
  );
