      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center">
            <input
              required
              className="w-full py-3 px-3 text-xl bg-richblack-800 text-white rounded-l-lg focus:outline-none"
            ...
            />
            <span
              className="px-3 py-4 text-xl bg-richblack-800 text-white hover:cursor-pointer rounded-r-lg"
              onClick={() => {
